...
export const AdminReportsList = ({
  ...
  const reportsList =
    adminReports && adminReports.length > 0 ? adminReports : reports || [];
      ...
      <div className="space-y-4 text-left">
        {reportsData.length === 0 ? (
          ...
          reportsData.map((rep) => {
            ...
            const isPending =
              rep.status === "pending" || (!isResolved && !isDismissed);
              ...
              >
                <div className="space-y-3.5 max-w-2xl">
                  <div className="flex items-center gap-3">
                    <span
                      className={`text-[10px] px-2.5 py-1 rounded-full font-black uppercase tracking-wider ${badgeClass}`}
                    >
                      {rep.status}
                    </span>
                  ...
                  <div>
                    <p className="text-xs text-slate-700 leading-relaxed">
                      ...
                      {reporterPhone && (
                        <span className="text-[11px] font-mono text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100 font-bold">
                          ({reporterPhone})
                        </span>
                      )}{" "}
                      reported{" "}
                      ...
                      {reportedPhone && (
                        <span className="text-[11px] font-mono text-rose-600 bg-rose-50 px-2 py-0.5 rounded border border-rose-100 font-bold">
                          ({reportedPhone})
                        </span>
                      )}{" "}
                      for:{" "}
