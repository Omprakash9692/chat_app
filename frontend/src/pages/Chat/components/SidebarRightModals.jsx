...
export const SidebarRightModals = ({
  ...
  const [isConfirmAssignLeaveOpen, setIsConfirmAssignLeaveOpen] =
    useState(false);
  ...
  return (
    <>
      ...
      >
        <div className="space-y-4 text-left p-1 select-none">
          <p className="text-xs text-slate-600 font-medium">
            Are you sure you want to leave this group space? You will no longer
            receive new messages from group members.
          </p>
      ...
      <Modal
        isOpen={isConfirmAssignLeaveOpen}
        onClose={() => setIsConfirmAssignLeaveOpen(false)}
        title="Confirm Admin Assignment & Exit"
        size="sm"
      >
        <div className="space-y-4 text-left p-1 select-none">
          <p className="text-xs text-slate-600 font-medium leading-relaxed">
            ...
            as the new group admin and exit{" "}
            <span className="font-extrabold text-slate-900">"{groupName}"</span>
            ?
          </p>
          <div className="flex justify-end gap-3 pt-2">
            <Button
              variant="outline"
              onClick={() => setIsConfirmAssignLeaveOpen(false)}
            >
              Cancel
            </Button>
            <Button
      ...
      >
        <div className="space-y-4 text-left p-1 select-none">
          <p className="text-xs text-slate-600 font-medium">
            ...
            All message history will be deleted for all members.
          </p>
          <div className="flex justify-end gap-3 pt-2">
            <Button
              variant="outline"
